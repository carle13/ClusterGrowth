...
# model = GM(numDirs, max_iter=0, tol=1e-9)
# model.fit(X)
# means = model.means_
...
p = ax.contourf(X, Y, Z, cmap = ListedColormap(('C0', 'C1', 'C4', 'C3', 'C2', 'C7', 'C6', 'C5')))
...
plt.tight_layout()
plt.savefig('databaseClassification.png', bbox_inches='tight')