...
posV = [[279,558,1799,2000], [259,302,1256,2000], [66,288,507,1318], [22,88,309,2000], [136,761,1620,2000]]
...
for s in range(1, 6):
    ...
    for d in probs:
        ...
        for b in range(ranges[s-1][0], ranges[s-1][1], 20):
            ...
            pipeline = import_file('Output/T_920K/seed'+str(seed)+'/dump'+str(b*1000)+'.PROB.trj', multiple_frames=True)
