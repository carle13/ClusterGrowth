...
ranges = [[0,950], [0,950], [0,950], [0,950], [0,950]]
posV = [[83,121,291,945], [115,278,489,920], [220,304,408,930], [175,261,487,930], [169,362,655,940]]
...
for s in range(1, 6):
    ...
    for d in probs:
        ...
        for b in range(ranges[s-1][0], ranges[s-1][1], 20):
            ...
            pipeline = import_file('Output/T_980K/seed'+str(seed)+'/dump'+str(b*1000)+'.PROB.trj', multiple_frames=True)
