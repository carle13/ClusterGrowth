...
for s in range(1, 6):
    ...
    for d in probs:
        vals = []
        for b in range(0,500,2):
            #Count particles belonging to the cluster
            pipeline = import_file('1_WRZ/Output/500ps/seed'+str(seed)+'/dump'+str(b*1000)+'.PROB.trj', multiple_frames=True)
