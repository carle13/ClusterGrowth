...
for d in probs:
    ...
    for b in range(21):
        ...
        pipeline = import_file('Output/MELTCoulomb/dump'+str(b*500)+'.PROB.trj', multiple_frames=True)
...
#Draw plot
plt.figure()
plt.title('WRZ Melting Simulation (1500K - 3000K)')
plt.xlabel('$t$ / ps')
plt.ylabel('$N$')
